...
#combien de handle commencant par une majuscule :
#/[[:upper:]]/

puts people_array.count{|handle| /[[:upper:]]/.match(handle[1])}

# [1] defini la recherche en sautant d'un caractère
